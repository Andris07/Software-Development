...
-- 6. feladat
SELECT `vnev`, `knev` FROM `tanulok` ORDER BY `vnev` ASC, `knev` ASC;
-- 7. feladat
...
-- 16. feladat
SELECT `vnev`, `knev`, `szul_ido` FROM `tanulok` WHERE `szul_hely`='Budapest' AND `nem`='F' ORDER BY `szul_ido` DESC;
-- 17. feladat
SELECT * FROM `tanulok` WHERE `magassag` <= 170 AND `magassag` >= 160 AND `nagycsalados` = '1' AND `nem`='N' ORDER BY `szul_ido` DESC;
-- 18. feladat
